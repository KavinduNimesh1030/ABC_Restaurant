            ...
            <div class="col-md mb-4 mb-md-0">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-10">
                                <h5 class=" align-middle">Products Add</h5>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary" name="submitButton"
                                        id="btnProductSave"> <span class="spinner-border spinner-border-sm d-none"
                ...
                bsValidationForms.each(function() {
                    $(this).on('submit', function(event) {
                        ...
                        if (!this.checkValidity()) {
                            ...
                            $("#btnProductSave").html('Submitting..');
                            $("#btnProductSave").prop('disabled', true);
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    showSuccessAlert("Product stored successfully", 'success',
                                        '{{ route('product.list-view') }}');

                                },
                                error: function(error) {
                                    $("#btnProductSave").html('Submitt');
